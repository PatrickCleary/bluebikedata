...
export const ShapeSelection = () => {
  ...
  return (
    <div className="relative md:h-full md:my-2 flex flex-row md:flex-col z-10 w-full md:w-fit bg-gray-800 md:gap-4 px-2 md:px-4 py-2 text-gray-100 rounded-md pointer-events-auto  items-center border border-gray-500">
      <DrawingMenu />
